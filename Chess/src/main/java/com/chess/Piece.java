...
public class Piece {
    ...
    private List<Move> getValidPawnMoves() {
        ...
        if (game.getPieceAt(this.locR + direction, this.locC) == null) {
            validPawnMoves.add(new Move(this, null, this.locR, this.locC, this.locR + direction, this.locC));
        }
        ...
        for (int i = -1; i <= 1; i += 2) {
            if (withinBoard(this.locC + i, this.locR + direction)) {
                ...
                if (capture != null && capture.color != this.color) {
                    validPawnMoves.add(new Move(this, capture, this.locR, this.locC, this.locR + direction, this.locC + i));
                }
            }
        }
